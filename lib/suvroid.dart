...
class Suvroid extends StatefulWidget {
  @override
  _SuvroidState createState() => _SuvroidState();
}

class _SuvroidState extends State<Suvroid> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          launcher("tel: 01683465006");
                        },
                        child: Container(
                            height:18,
                            width:80,
                            color: Colors.white,
                            child: Text("01683465006")),
                      ),
                    ],
                  ),
                  SizedBox(
