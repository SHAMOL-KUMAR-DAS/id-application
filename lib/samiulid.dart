...
class Samiulid extends StatefulWidget {
  @override
  _SamiulidState createState() => _SamiulidState();
}

class _SamiulidState extends State<Samiulid> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          launcher("tel: 01757734805");
                        },
                        child: Container(
                            height:18,
                            width:80,
                            color: Colors.white,
                            child: Text("01757734805")),
                      ),
                    ],
                  ),
                  SizedBox(
