...
class Farihaid extends StatefulWidget {
  @override
  _FarihaidState createState() => _FarihaidState();
}

class _FarihaidState extends State<Farihaid> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          launcher("tel: 01718020291");
                        },
                        child: Container(
                            height:18,
                            width:80,
                            color: Colors.white,
                            child: Text("01718020291")),
                      ),
                    ],
                  ),
                  SizedBox(
