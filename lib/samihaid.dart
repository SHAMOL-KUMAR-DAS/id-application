...
class Samihaid extends StatefulWidget {
  @override
  _SamihaidState createState() => _SamihaidState();
}

class _SamihaidState extends State<Samihaid> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          launcher("tel: 01741579835");
                        },
                        child: Container(
                            height:18,
                            width:80,
                            color: Colors.white,
                            child: Text("01741579835")),
                      ),
                    ],
                  ),
                  SizedBox(
