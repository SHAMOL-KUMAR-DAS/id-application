...
class Amanullahid extends StatefulWidget {
  @override
  _AmanullahidState createState() => _AmanullahidState();
}

class _AmanullahidState extends State<Amanullahid> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          launcher("tel: 01710517010");
                        },
                        child: Container(
                            height:18,
                            width:80,
                            color: Colors.white,
                            child: Text("01710517010")),
                      ),
                    ],
                  ),
                  SizedBox(
