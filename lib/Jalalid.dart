...
class Jalalid extends StatefulWidget {
  @override
  _JalalidState createState() => _JalalidState();
}

class _JalalidState extends State<Jalalid> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          launcher("tel: 01720945217");
                        },
                        child: Container(
                            height:18,
                            width:80,
                            color: Colors.white,
                            child: Text("01720945217")),
                      ),
                    ],
                  ),
                  SizedBox(
